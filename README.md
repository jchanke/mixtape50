...
To do this, visit [http://localhost:5000/login](http://localhost:5000/login) to login to Spotify.
And if you'd like to logout, visit [http://localhost:5000/logout](http://localhost:5000/logout).
